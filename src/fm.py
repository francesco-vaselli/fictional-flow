...
class MyExactOptimalTransportConditionalFlowMatcher(ConditionalFlowMatcher):
    ...
    def __init__(self, sigma: Union[float, int] = 0.0, sampler_method="exact"):
        ...
        self.ot_sampler = OTPlanSampler(method=sampler_method)
